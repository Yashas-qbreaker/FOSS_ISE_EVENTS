...
import PixelLiquidBackground from "@/components/PixelLiquidBackground";
import poster from "@/assets/poster_1.jpg";
import fossLogo from "@/assets/FOSS_CLUB_LOGO.png";

const EventOne = () => {
  return (
    <div className="min-h-screen relative overflow-y-auto">
      <PixelLiquidBackground />
          ...
          <div className="grid lg:grid-cols-[400px,1fr] gap-8 items-start">
            ...
            <main className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                AI-Powered Creative Evolution Challenge
              </p>
            </div>
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-foreground/70 mb-4">
                      Register now to secure your spot for this exciting AI-powered creative challenge. 
                      We will confirm your registration shortly.
                    </p>
                    <div className="flex items-center gap-3 mb-4">
                      <Link to="/register-pixel2portal">
              ...
              <div className="glass-card p-6 md:p-8 rounded-2xl border border-border/50 backdrop-blur-xl bg-background/40">
                ...
                <div className="space-y-4 text-foreground/80 leading-relaxed">
                  <p>
                    Pixel2Portal is a next-generation Generative AI event crafted to showcase 
                    creativity, design thinking, and technical innovation. Teams progress 
                    through three transformation stages, where concepts evolve from initial 
                    visuals into dynamic motion pieces, and ultimately into functional 
              ...
              <div className="space-y-3 pt-4">
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-foreground">Stage One: GENESIS</p>
                          <p className="text-sm text-foreground/70">
                            Create your first AI-generated visual based on the secret theme.
                          </p>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-foreground">Stage Two: MOMENTUM</p>
                          <p className="text-sm text-foreground/70">
                            Expand your Genesis visual into a motion-based or narrative-driven AI output.
                          </p>
                        </div>
                      </li>
                      <li className="flex items-start gap-3">
                        ...
                        <div>
                          <p className="font-medium text-foreground">Stage Three: CONSTRUCT</p>
                          <p className="text-sm text-foreground/70">
                            Convert your concept into a functional AI-assisted website.
                          </p>
                        </div>
                      </li>
                    </ul>
                  ...
                  <li>AI tools must be used meaningfully in every stage</li>
                  <li>Themes revealed through QR codes</li>
                  <li>Strict time limits per stage</li>
                  <li>No pre-made templates or external assets</li>
                </ul>
              </div>
                </div>
              </div>
